...
const Hero = () => {
  return (
    <div style={{backgroundImage: 'url(./assets/images/webp/hero-bg-image.webp)' }} id='hero' className='bg-cover min-h-[807px] max-xl:min-h-[1048px] max-md:min-h-[603px] bg-center bg-no-repeat'>
